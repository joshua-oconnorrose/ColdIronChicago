...
while ($event_row = mysql_fetch_assoc($get_events)){
	...
	if ($compare_case != $compare_against){
		if($loopcount == 1){
			echo "<tr><td class=\"heading\" align=\"center\" colspan=\"6\">". $table_title  ."</td></tr>";
			if($show_slot_p==0){
			echo "<tr><td class=\"note\" align=\"center\" colspan=\"6\">By ". $event_row["author"]  . " APL ".$event_row["bottom_apl"]."-".$event_row["top_apl"]."</td></tr>";
			echo "<tr><td class=\"normal\" align=\"left\" colspan=\"6\"><div style=\"margin-top=0pt;margin: 10pt;\">". $event_row["description"]  ."</div></td></tr>";
			
			}
		}
		if($loopcount != 1){
			echo "<tr><td class=\"normal\" colspan=\"6\">Judges:</td></tr>";
			...
			$judge_html = '';
			$judge_row = 0;
			echo "<tr><td class=\"normal\" colspan=\"6\">Players:</td></tr>";
			...
			echo "<td class=\"normal\" colspan=\"1\"><b>Goals</b></td>";
				echo $player_html;}
			else{
		...
		?>
		 <tr>
			<?php echo "<td colspan=\"6\"><a class='normal' href='".$register_link."'><b style=\"color:blue\">$section_header</b></a></td>";?>
		</tr>
		<?php
		}
		else{
		?>
		 <tr>
			<?php echo "<td colspan=\"6\"><br><b style=\"color:blue\">$section_header</b></td>";?>
		</tr>
		<?php
		...
		if($event_row["character_id"]==4){
			...
			$judge_html .="<td class=\"normal\" colspan=\"5\">". $event_row["first_name"]. " " .$event_row["last_name"] ."</td>";
			$judge_html .="</tr>";
		...
		elseif(isset($event_row["character_id"])){
			...
			$player_html.="<td class=\"normal\">".$formattedString."</td>";
			$player_html.="</tr>";
			}
