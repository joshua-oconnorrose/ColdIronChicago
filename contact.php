...
switch ($attributes["form_action"]) {
	...
	case 'edit':
		...
		break;
    case 'Update':
		$updateSQL = sprintf("update convention_text set contact=%s where con_id = %s",
...
$query = 'SELECT contact'
	...
	$attributes['text'] = $textData['contact'];
		...
		if (ListContainsNoCase($_SESSION["roleList"],"admin"))
			{
				...
				echo "<br><a href='contact.php?form_action=edit'>Edit This Page</a>";
				}
			}
